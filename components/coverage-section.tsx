...
const regions = [
  {
    name: 'دبي (Dubai)',
    description: 'الموقع متاح للإيجار. للتواصل: +20 10 10742430. تغطية طوارئ شاملة واستجابة سريعة في أقل من 45 دقيقة لكافة أحياء ومناطق دبي.',
    areas: ['ديرة', 'بر دبي', 'جميرا', 'البرشاء', 'دبي مارينا', 'السطوة', 'القوز', 'الكرامة', 'نخلة جميرا', 'المرابع العربية'],
    color: 'blue'
  },
  {
    name: 'الشارقة (Sharjah)',
    description: 'الموقع متاح للإيجار. للتواصل: +20 10 10742430. خدمات كهربائية معتمدة ومتوفرة على مدار الساعة في مختلف ضواحي مدينة الشارقة.',
    areas: ['المجاز', 'التعاون', 'الخان', 'مويلح', 'النهضة', 'القاسمية', 'اليرموك', 'الرحمانية', 'القرائن', 'الصناعية'],
    color: 'orange'
  },
  {
    name: 'عجمان (Ajman)',
    description: 'الموقع متاح للإيجار. للتواصل: +20 10 10742430. أفضل فنيين الكهرباء في عجمان للصيانة المنزلية بكافة المناطق السكنية والتجارية.',
