import { CheckCircle2,ChevronRight,Clock,Info,MapPin,MessageCircle,PenTool,ShieldCheck } from '@/components/icons';
...
export const metadata = {
  title: 'كهربائي منازل في دبي - +201010742430 | فني كهرباء الامارات طوارئ 24 ساعة | الموقع متاح للإيجار',
  description: 'الموقع متاح للإيجار. للتواصل: +201010742430. ابحث عن أفضل كهربائي منازل في دبي +201010742430. شركة فني كهرباء الامارات تقدم خدمات تصليح، صيانة أعطال، وتأسيس كهرباء للفلل بأسعار رخيصة وخدمة 24 ساعة.',
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="bg-white p-6 shadow-sm border border-gray-200 rounded-lg">
              ...
              <div className="prose max-w-none text-gray-700 leading-relaxed text-base md:text-lg space-y-6">
                ...
                <p>
                  من الأعطال الطارئة مثل انقطاع التيار الكهربائي أو الالتماسات المفاجئة، إلى تجهيز التمديدات الحديثة وأنظمة المنازل الذكية (Smart Home)، يحتاج كل مسكن في دبي لرقم <strong>كهربائي دبي</strong> متاح للتدخل العاجل. اتصل الآن على الخط الساخن <strong>+201010742430</strong> للحصول على أمهر الفنيين وأرخص الأسعار.
                </p>
              ...
              <section id="faq">
                ...
                <FAQAccordion faqs={[
                  ...
                  },
                  {
                    ...
                    answer: 'يمكنك ببساطة الانصال على رقمنا المباشر +201010742430، أو ترك رسالة على الواتس آب، أو الحجز عبر النموذج الموجود بنهاية هذه الصفحة.'
                  },
                  {
                  ...
                  __html: JSON.stringify({
                    ...
                    "mainEntity": [
                      ...
                      },
                      {
                        ...
                        "acceptedAnswer": {
                          "@type": "Answer",
                          "text": "يمكنك ببساطة الانصال على رقمنا المباشر +201010742430، أو ترك رسالة على الواتس آب."
                        }
                      },
                      {
                        "@type": "Question",
