        ...
        <div className="relative h-64 md:h-80 bg-gradient-to-l from-amazon-orange to-[#FFD814] rounded-lg p-6 overflow-hidden shadow-sm flex items-center">
          ...
          <div className="relative z-10 max-w-lg space-y-4 text-amazon-blue">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <a href="https://wa.me/971522815005" target="_blank" rel="noopener noreferrer" className="bg-white text-amazon-blue px-4 py-2 rounded-full font-bold border border-gray-300 shadow-sm flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors text-sm">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="bg-white p-4 shadow-sm border border-gray-200 text-center">
              ...
              <div className="flex items-center justify-center gap-1 text-[#007185] font-bold text-sm mb-3">
                <PhoneCall className="w-4 h-4" /> +971 52 281 5005
              </div>
              <a href="https://wa.me/971522815005" target="_blank" rel="noopener noreferrer" className="inline-flex w-full items-center justify-center gap-2 bg-white hover:bg-gray-50 text-amazon-blue px-4 py-2 rounded font-bold transition-colors text-sm shadow-sm border border-gray-300">
