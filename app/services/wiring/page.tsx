...
export const metadata = {
  ...
  description: 'الموقع متاح للإيجار. للتواصل: +201010742430. أفضل مقاول تمديدات كهربائية وتأسيس كهرباء للمنازل والمشاريع التجارية في دبي والشارقة وعجمان. موافقات ديوا وتأسيس أنظمة السمارت هوم بأعلى معايير الجودة.',
  alternates: {
