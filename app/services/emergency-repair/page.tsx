...
export const metadata = {
  ...
  description: 'الموقع متاح للإيجار. للتواصل: +201010742430. أفضل خدمة طوارئ وإصلاح أعطال كهربائية على مدار 24 ساعة في دبي، الشارقة، وعجمان. فني كهربائي معتمد لإصلاح الالتماسات وانقطاع التيار الكهربائي فوراً.',
  alternates: {
...
const serviceSchema = {
  ...
  "description": "الموقع متاح للإيجار. للتواصل: +201010742430. نقدم خدمة استجابة سريعة للتعامل مع كافة الحالات الكهربائية الطارئة والمستعجلة. فريقنا من الفنيين المعتمدين والمعدين جيداً يصلون إليك في غضون وقت قصير (30 إلى 45 دقيقة) لتشخيص وإصلاح العطل بأعلى درجات الأمان والاحترافية.",
  "provider": {
    "@type": "Organization",
