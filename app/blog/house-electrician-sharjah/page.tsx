...
export const metadata: Metadata = {
  ...
  description: `تبحث عن كهربائي منازل بالشارقة يصلك بسرعة؟ نقدم لك في فني كهرباء الامارات خدمات صيانة وإصلاح الأعطال بأسعار واضحة وضمان معتمد. اتصل الآن 971502067679+`,
  alternates: {
...
const tocItems = [
  { id: "section-1", title: "لماذا يحتاج كل منزل في الشارقة إلى فني كهربائي موثوق؟" },
  { id: "section-2", title: "المخاطر المترتبة على إهمال الأعطال الكهربائية" },
  { id: "section-3", title: "خدمات كهربائي منازل بالشارقة التي يقدمها فني كهرباء الإمارات" },
  { id: "section-4", title: "1. إصلاح الأعطال الطارئة" },
  { id: "section-5", title: "2. تمديدات الكهرباء للفلل والمنازل الجديدة" },
  { id: "section-6", title: "3. الصيانة الوقائية والدورية" },
  { id: "section-7", title: "4. تركيب مفاتيح وإضاءة حديثة" },
  { id: "section-8", title: "5. تأسيس أنظمة المنازل الذكية" },
  { id: "section-9", title: "أسباب انقطاع الكهرباء في الشارقة وكيفية التعامل معها" },
  { id: "section-10", title: "خطوات أولية عند حدوث عطل مفاجئ" },
  { id: "section-11", title: "كيف تجد كهربائي قريب مني بالشارقة في أسرع وقت؟" },
  { id: "section-12", title: "أحياء الشارقة التي نغطيها بالكامل" },
  { id: "section-13", title: "معايير اختيار معلم كهربائي منازل في الشارقة" },
  { id: "section-14", title: "نصائح هامة لسلامة التمديدات الكهربائية في المنزل" },
  { id: "section-15", title: "الأسئلة الشائعة حول خدمات الكهرباء بالشارقة" },
  { id: "section-16", title: "ما هو رقم كهرباء الشارقة المجاني؟" },
  { id: "section-17", title: "كم سعر خدمات تصليح الكهرباء بالشارقة؟" },
  { id: "section-18", title: "هل توجد صيانة طارئة طوال الـ 24 ساعة؟" },
      ...
      <div className="max-w-4xl mx-auto px-4 w-full">
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-amazon-blue leading-tight mb-4">
            كهربائي منازل بالشارقة: دليلك لأفضل خدمة صيانة سريعة 502067679
          </h1>
        </div>
