...
export const metadata: Metadata = {
  title: `كهربائي منازل في الشارقة: خدمات احترافية وطوارئ 24 ساعة | فني كهرباء الامارات | +201010742430 | الموقع متاح للإيجار`,
  description: `الموقع متاح للإيجار. للتواصل: +201010742430. كهربائي منازل في الشارقة يقدم خدمات احترافية تشمل الصيانة والتركيب والإصلاح، مع سرعة استجابة وضمان جودة العمل للحفاظ على كفاءة الأنظمة الكهربائية المنزلية`,
  alternates: {
    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 w-full">
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-amazon-blue leading-tight mb-4">كهربائي منازل في الشارقة: خدمات احترافية وطوارئ 24 ساعة | +201010742430</h1>
        </div>
