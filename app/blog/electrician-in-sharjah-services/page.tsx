      ...
      <article className="max-w-4xl mx-auto px-4 py-10 w-full">
        ...
        <div className="prose max-w-none text-gray-700 leading-relaxed text-base md:text-lg space-y-6">
          ...
          <section id="near-me">
            ...
            <p>
              يمكنك التواصل وحجز زيارة منزلية الآن عبر نموذج الحجز أو الاتصال على الرقم: <a href="https://wa.me/971522815005" className="text-[#007185] hover:underline" dir="ltr">+971 52 281 5005</a> للحصول على خدمة فورية.
            </p>
          </section>
