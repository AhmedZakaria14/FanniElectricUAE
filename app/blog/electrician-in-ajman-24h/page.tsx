...
const tocItems = [
  ...
  { id: "section-2", title: "الخدمات التي يقدمها فني كهرباء الإمارات في عجمان | الموقع متاح للإيجار" },
  { id: "section-3", title: "1. تصليح كهرباء المنازل والأعطال الطارئة | الموقع متاح للإيجار" },
  { id: "section-4", title: "2. تمديدات الكهرباء للفلل والمباني الجديدة | الموقع متاح للإيجار" },
  { id: "section-5", title: "3. صيانة القواطع واللوحات الرئيسية | الموقع متاح للإيجار" },
  { id: "section-6", title: "4. تركيب الإضاءة بجميع أنواعها | الموقع متاح للإيجار" },
  { id: "section-7", title: "5. تاسيس أنظمة المنازل الذكية | الموقع متاح للإيجار" },
  { id: "section-8", title: "أشهر الأعطال الكهربائية في عجمان وكيفية التصرف معها | الموقع متاح للإيجار" },
  { id: "section-9", title: "أسباب انقطاع الكهرباء المفاجئ | الموقع متاح للإيجار" },
  { id: "section-10", title: "كيف تتصرف عند شم رائحة احتراق أو رؤية شرارة؟ | الموقع متاح للإيجار" },
  { id: "section-11", title: "كيف تجد كهربائي قريب مني في عجمان بسرعة؟ | الموقع متاح للإيجار" },
  { id: "section-12", title: "أحياء ومناطق عجمان التي نغطيها بالكامل | الموقع متاح للإيجار" },
  { id: "section-13", title: "معايير اختيار أفضل كهربائي في عجمان | الموقع متاح للإيجار" },
  { id: "section-14", title: "نصائح هامة لسلامة الشبكة الكهربائية في منزلك | الموقع متاح للإيجار" },
  { id: "section-15", title: "الأسئلة الشائعة حول خدمات الكهرباء في عجمان | الموقع متاح للإيجار" },
  { id: "section-16", title: "ما هو رقم كهرباء عجمان المجاني؟ | الموقع متاح للإيجار" },
  { id: "section-17", title: "كم سعر تصليح الكهرباء في عجمان؟ | الموقع متاح للإيجار" },
  { id: "section-18", title: "هل توجد خدمة صيانة كهرباء طوارئ في الليل؟ | الموقع متاح للإيجار" },
...
<p dir="rtl" class="text-gray-700 leading-relaxed mb-6">افصل التيار فوراً من اللوحة الرئيسية ولا تلمس أي مفتاح واتصل بنا على <a href="tel:+201010742430" target="_blank" rel="noopener noreferrer" class="text-[#007185] hover:underline font-bold">+201010742430</a>.</p>
...
<p dir="rtl" class="text-gray-700 leading-relaxed mb-6">لصيانة الأعطال في منزلك تواصل معنا مباشرة على <a href="tel:+201010742430" target="_blank" rel="noopener noreferrer" class="text-[#007185] hover:underline font-bold">+201010742430</a>.</p>
...
<p dir="rtl" class="text-gray-700 leading-relaxed mb-6">احفظ رقم فني كهرباء الإمارات <a href="tel:+201010742430" target="_blank" rel="noopener noreferrer" class="text-[#007185] hover:underline font-bold">+201010742430</a>، أو احجز مباشرة عبر <a href="https://www.fannielectricuae.com/#booking" target="_blank" rel="noopener noreferrer" class="text-[#007185] hover:underline font-bold">نموذج الحجز المباشر</a> للحصول على أسرع وأمن خدمة كهربائي في عجمان.</p>
