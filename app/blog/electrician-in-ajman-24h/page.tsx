...
export const metadata: Metadata = {
  title: `أفضل كهربائي في عجمان | +20 10 10742430+ | الموقع متاح للإيجار`,
  description: `الموقع متاح للإيجار. للتواصل: +20 10 10742430. هل تبحث عن كهربائي في عجمان موثوق وسريع؟ يقدم لك فني كهرباء الإمارات أفضل خدمات تصليح كهرباء المنازل والتمديدات بأسعار واضحة وضمان معتمد على مدار 24 ساعة. اتصل الآن على +20 10 10742430+.`,
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-4 w-full">
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-amazon-blue leading-tight mb-4">
            كهربائي في عجمان | +20 10 10742430+
          </h1>
        </div>
...
"هل تبحث عن كهربائي في عجمان موثوق وسريع؟ يقدم لك فني كهرباء الإمارات أفضل خدمات تصليح كهرباء المنازل والتمديدات بأسعار واضحة وضمان معتمد على مدار 24 ساعة. اتصل الآن على +20 10 10742430+."
</blockquote>
