...
export const metadata: Metadata = {
  title: `خدمات تأسيس كهرباء المنازل الذكية في الإمارات | +201010742430 | الموقع متاح للإيجار`,
  description: `الموقع متاح للإيجار. للتواصل: +201010742430. دليلك الشامل لتأسيس كهرباء المنازل الذكية في الإمارات مع فني كهرباء الامارات، خطوة بخطوة من البنية التحتية إلى التركيب والبرمجة بأسعار واضحة وضمان معتمد. اتصل الآن +201010742430`,
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-4 w-full">
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-amazon-blue leading-tight mb-4">
            تأسيس كهرباء المنازل الذكية في الإمارات | +201010742430
          </h1>
        </div>
