...
export const metadata: Metadata = {
  title: `خدمات تأسيس كهرباء المنازل الذكية في الإمارات | 971502067679+`,
  description: `دليلك الشامل لتأسيس كهرباء المنازل الذكية في الإمارات مع فني كهرباء الامارات، خطوة بخطوة من البنية التحتية إلى التركيب والبرمجة بأسعار واضحة وضمان معتمد. اتصل الآن 971502067679+`,
  alternates: {
...
const tocItems = [
  { id: "section-1", title: "ما هي كهرباء المنازل الذكية ولماذا تحولت إلى ضرورة في الإمارات؟" },
  { id: "section-2", title: "الفرق بين تأسيس الكهرباء التقليدية والكهرباء الذكية" },
  { id: "section-3", title: "البنية التحتية المطلوبة لتأسيس منزل ذكي في الإمارات" },
  { id: "section-4", title: "1. كوابل البيانات والشبكة المحلية (Ethernet Cables)" },
  { id: "section-5", title: "2. مفاتيح وقواطع المحايد (Neutral Wire Requirement)" },
  { id: "section-6", title: "3. اللوحات الكهربائية الموزعة والذكية" },
  { id: "section-7", title: "4. شبكة Wi-Fi ومقويات الإشارة" },
  { id: "section-8", title: "مراحل تأسيس كهرباء المنازل الذكية خطوة بخطوة" },
  { id: "section-9", title: "المرحلة الأولى: التخطيط الهندسي ودراسة المتطلبات" },
  { id: "section-10", title: "المرحلة الثانية: التأسيس الأولي (الأسود) وسحب الكوابل" },
  { id: "section-11", title: "المرحلة الثالثة: التركيب النهائي والبرمجة" },
  { id: "section-12", title: "أهم الأجهزة والأنظمة الذكية التي يمكن ربطها بالشبكة" },
  { id: "section-13", title: "خيارات التأسيس الذكي في الفلل القديمة بدون تكسير" },
  { id: "section-14", title: "خدمات فني كهرباء الإمارات في تأسيس المنازل الذكية" },
  { id: "section-15", title: "تغطية الخدمة في دبي والشارقة وعجمان" },
  { id: "section-16", title: "الأسئلة الشائعة حول تأسيس المنازل الذكية" },
  { id: "section-17", title: "كم تكلفة تأسيس كهرباء منزل ذكي في الإمارات؟" },
  { id: "section-18", title: "هل يمكن تحويل منزل قديم إلى منزل ذكي بدون تكسير الحوائط؟" },
  { id: "section-19", title: "هل تعمل الأجهزة الذكية في حال انقطاع الإنترنت؟" },
      ...
      <div className="max-w-4xl mx-auto px-4 w-full">
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-amazon-blue leading-tight mb-4">
            تأسيس كهرباء المنازل الذكية في الإمارات | 971502067679+
          </h1>
        </div>
