      ...
      <article className="max-w-4xl mx-auto px-4 py-10 w-full">
        ...
        <div className="prose max-w-none text-gray-700 leading-relaxed text-base md:text-lg space-y-6">
          ...
          <section id="services">
            ...
            <p>
              توفر الشركة خدمات شاملة تشمل الكشف عن التماس كهربائي في البيت، إصلاح الأعطال، صيانة اللوحات الكهربائية، وتركيب الأنظمة الحديثة، كما تغطي خدماتها عدة مناطق في عجمان مثل:
            </p>
          ...
          <section id="maintenance">
            ...
            <p>
              تساعد الصيانة الدورية التي تقدمها Fanni Electric UAE في تقليل مخاطر التماس الكهربائي بشكل كبير، من خلال فحص الأسلاك وتحديث التمديدات القديمة.
            </p>
            <p>
              كما تساهم هذه الصيانة في منع تكرار أعراض التماس الكهربائي في المنزل وتحسين كفاءة استهلاك الطاقة داخل المباني.
            </p>
          </section>
          ...
          <section id="inspection">
            ...
            <p>
              يُعد فحص التمديدات الكهربائية خطوة أساسية للوقاية من التماس الكهربائي والحفاظ على سلامة المنزل، حيث يساعد الفحص الدوري في اكتشاف أي خلل مبكر قبل أن يتحول إلى مشكلة كبيرة مثل التماس الكهربائي في البيت.
            </p>
            <p>
