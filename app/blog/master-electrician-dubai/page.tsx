...
export const metadata: Metadata = {
  title: `خدمات معلم كهرباء بدبي: دليلك لاختيار الأفضل بثقة وأمان 502067679`,
  description: `تبحث عن معلم كهرباء بدبي محترف وسريع؟ فني كهرباء الإمارات يوفر كهربائي منازل معتمد لإصلاح الأعطال والتمديدات على مدار الساعة. اتصل الآن 971502067679+.`,
  alternates: {
...
const tocItems = [
  { id: "section-1", title: "لماذا تحتاج إلى فني كهرباء محترف وليس أي شخص عشوائي؟" },
  { id: "section-2", title: "ما الفرق بين الكهربائي الهاوي والفني المحترف؟" },
  { id: "section-3", title: "ما الخدمات التي يجب أن يقدمها معلم كهرباء بدبي محترف؟" },
  { id: "section-4", title: "1. إصلاح الأعطال الطارئة" },
  { id: "section-5", title: "2. التمديدات الكهربائية المنزلية والتجارية" },
  { id: "section-6", title: "3. الصيانة الدورية والوقائية" },
  { id: "section-7", title: "4. تركيب الأنظمة الذكية" },
  { id: "section-8", title: "كيف تختار الفني الأنسب لك في دبي؟" },
  { id: "section-9", title: "فني كهرباء الامارات: وجهة موثوقة لخدمات الكهرباء في دبي" },
  { id: "section-10", title: "أسباب تفضيل كثير من العملاء لهذه الخدمة" },
  { id: "section-11", title: "علامات تستدعي التواصل الفوري مع معلم كهرباء بدبي" },
  { id: "section-12", title: "نصائح للحفاظ على شبكة الكهرباء في المنزل" },
  { id: "section-13", title: "كيفية العثور على معلم كهرباء بدبي بسرعة" },
  { id: "section-14", title: "الأسئلة الشائعة" },
  { id: "section-15", title: "كم راتب فني الكهرباء في الإمارات؟" },
  { id: "section-16", title: "ما هو رقم كهرباء دبي المجاني؟" },
  { id: "section-17", title: "ما هي شركات تصليح الكهرباء في دبي؟" },
  { id: "section-18", title: "كيف يمكن الحصول على توصيل كهرباء في دبي؟" },
      ...
      <div className="max-w-4xl mx-auto px-4 w-full">
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-amazon-blue leading-tight mb-4">
            معلم كهرباء بدبي: دليلك لاختيار الأفضل بثقة وأمان 502067679
          </h1>
        </div>
