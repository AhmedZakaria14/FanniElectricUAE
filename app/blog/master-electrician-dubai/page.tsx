...
export const metadata: Metadata = {
  title: `خدمات معلم كهرباء بدبي: دليلك لاختيار الأفضل بثقة وأمان 502067679 | الموقع متاح للإيجار`,
  description: `الموقع متاح للإيجار. للتواصل: +20 10 10742430. تبحث عن معلم كهرباء بدبي محترف وسريع؟ فني كهرباء الإمارات يوفر كهربائي منازل معتمد لإصلاح الأعطال والتمديدات على مدار الساعة. اتصل الآن +20 10 10742430+.`,
  alternates: {
