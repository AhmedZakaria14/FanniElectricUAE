...
export const metadata: Metadata = {
  title: `فني كهربائي 24 ساعة في دبي والشارقة وعجمان | 502067679`,
  description: `كهربائي 24 ساعة في دبي والشارقة وعجمان يصلك خلال دقائق لحل أي عطل كهربائي طارئ، تعرف على خدماتنا وأسعارنا ومناطق التغطية مع فني كهرباء الامارات.`,
  alternates: {
...
const tocItems = [
  { id: "section-1", title: "لماذا تحتاج كهربائي 24 ساعة في حياتك اليومية؟" },
  { id: "section-2", title: "خدمات كهربائي 24 ساعة التي نقدمها" },
  { id: "section-3", title: "إصلاح الأعطال الطارئة" },
  { id: "section-4", title: "التمديدات الكهربائية" },
  { id: "section-5", title: "الصيانة الدورية والوقائية" },
  { id: "section-6", title: "تركيب الإنارة والمفاتيح" },
  { id: "section-7", title: "تأسيس أنظمة المنازل الذكية" },
  { id: "section-8", title: "كهربائي في دبي – تغطية شاملة لكل الأحياء" },
  { id: "section-9", title: "كهربائي في الشارقة – استجابة سريعة على مدار الساعة" },
  { id: "section-10", title: "كهربائي في عجمان – فنيون في متناول اليد" },
  { id: "section-11", title: "كيف تختار كهربائي موثوق يعمل على مدار الساعة؟" },
  { id: "section-12", title: "علامات تدل على أنك بحاجة إلى كهربائي 24 ساعة فورا" },
  { id: "section-13", title: "نصائح للحفاظ على سلامة الشبكة الكهربائية في منزلك" },
  { id: "section-14", title: "خطواتنا في التعامل مع طلبك مع فني كهربائي الامارات" },
  { id: "section-15", title: "العوامل التي تؤثر على تكلفة خدمة كهربائي 24 ساعة" },
  { id: "section-16", title: "الأسئلة الشائعة" },
  { id: "section-17", title: "هل خدمة كهربائي 24 ساعة متاحة فعلا في أي وقت من الليل أو النهار؟" },
  { id: "section-18", title: "كم يستغرق وصول الفني بعد التواصل؟" },
  { id: "section-19", title: "هل يمكن معرفة تكلفة الإصلاح قبل بدء العمل؟" },
      ...
      <div className="max-w-4xl mx-auto px-4 w-full">
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-amazon-blue leading-tight mb-4">
            كهربائي 24 ساعة في دبي والشارقة وعجمان | 502067679
          </h1>
        </div>
