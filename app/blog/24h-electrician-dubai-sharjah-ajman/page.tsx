...
export const metadata: Metadata = {
  title: `فني كهربائي 24 ساعة في دبي والشارقة وعجمان | 502067679 | الموقع متاح للإيجار`,
  description: `الموقع متاح للإيجار. للتواصل: +20 10 10742430. كهربائي 24 ساعة في دبي والشارقة وعجمان يصلك خلال دقائق لحل أي عطل كهربائي طارئ، تعرف على خدماتنا وأسعارنا ومناطق التغطية مع فني كهرباء الامارات.`,
  alternates: {
