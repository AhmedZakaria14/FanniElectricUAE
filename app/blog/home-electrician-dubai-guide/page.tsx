...
export const metadata: Metadata = {
  title: `خدمات كهربائي منازل بدبي: دليلك لخدمة كهربائية سريعة 502067679`,
  description: `تبحث عن كهربائي منازل بدبي يحل مشكلتك بسرعة وأمان؟ تعرف على أفضل الحلول لتصليح كهرباء المنازل مع فني كهرباء الامارات. اتصل على 971502067679+`,
  alternates: {
...
const tocItems = [
  { id: "section-1", title: "لماذا تحتاج إلى كهربائي منازل بدبي محترف؟" },
  { id: "section-2", title: "علامات تدل على أنك بحاجة إلى فني كهرباء فورا" },
  { id: "section-3", title: "خدماتنا الشاملة لكل بيت في دبي" },
  { id: "section-4", title: "إصلاح الأعطال الطارئة" },
  { id: "section-5", title: "التمديدات الكهربائية الحديثة" },
  { id: "section-6", title: "الصيانة الدورية والوقائية" },
  { id: "section-7", title: "تصليح كهرباء المنازل: كيف تتم العملية باحترافية؟" },
  { id: "section-8", title: "1. التشخيص الدقيق للمشكلة" },
  { id: "section-9", title: "2. تحديد التكلفة مسبقا" },
  { id: "section-10", title: "3. الإصلاح والفحص النهائي" },
  { id: "section-11", title: "أخطاء شائعة عند محاولة تصليح كهرباء المنازل بنفسك" },
  { id: "section-12", title: "كيف تختار كهربائي قريب منك في دبي؟" },
  { id: "section-13", title: "مناطق تغطية خدمة كهربائي منازل في دبي" },
  { id: "section-14", title: "نصائح للحفاظ على سلامة الكهرباء في منزلك" },
  { id: "section-15", title: "الأسئلة الشائعة" },
  { id: "section-16", title: "ما هي شركات تصليح الكهرباء في دبي؟" },
  { id: "section-17", title: "رقم كهرباء دبي المجاني؟" },
  { id: "section-18", title: "كم يستهلك المنزل من الكهرباء شهريا؟" },
  { id: "section-19", title: "خاتمة" }
];
