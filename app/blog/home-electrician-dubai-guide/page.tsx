...
export const metadata: Metadata = {
  title: `خدمات كهربائي منازل بدبي: دليلك لخدمة كهربائية سريعة +201010742430 | الموقع متاح للإيجار`,
  description: `الموقع متاح للإيجار. للتواصل: +201010742430. تبحث عن كهربائي منازل بدبي يحل مشكلتك بسرعة وأمان؟ تعرف على أفضل الحلول لتصليح كهرباء المنازل مع فني كهرباء الامارات. اتصل على +201010742430`,
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-4 w-full">
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-amazon-blue leading-tight mb-4">
            كهربائي منازل بدبي: دليلك لخدمة كهربائية سريعة +201010742430
          </h1>
        </div>
